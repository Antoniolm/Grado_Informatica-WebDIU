 ...
 <div class="container">
          ...
          <div class="container" style="padding-right:0px;padding-left:0px">
            ...
            <div class="container" id="contperfil">
                <h3 align="center">Reservas activas</h3>
                <p align="center" id="parrafo"><Strong>-Id:</Strong> p3k4l2 <Strong style="margin-left:3%"> Fecha de creación:</Strong>15/06/2016 
                <a href="index.php?contenido=bajausu" >
                <input type="submit" value="Anular"  id="botonacti"></a>
                <a href="index.php?contenido=histo">
                <input type="submit" value="Visualizar" id="botonacti"></a>
                </p>
                <p align="center" id="parrafo" ><Strong>-Id:</Strong> p3k4l2 <Strong style="margin-left:3%"> Fecha de creación:</Strong>15/06/2016 
                <a href="index.php?contenido=bajausu" >
                <input type="submit" value="Anular" id="botonacti"></a>
